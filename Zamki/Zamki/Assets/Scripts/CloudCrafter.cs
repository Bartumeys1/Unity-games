...
public class CloudCrafter : MonoBehaviour
{
    ...
    public int numClouds = 40; // кількість хмарин
    public GameObject cloudPrefab;
    public Vector3 cloudPosMin = new Vector3(-50, -5, 10);
    public Vector3 cloudPosMax = new Vector3(150, 100, 10);
    public float cloudScaleMin = 1f; // мінімальний маштаб кожної хмаринки
    public float cloudScaleMax = 3f; // максимальний маштаб кожної хмаринки
    ...
    private void Awake()
    {
        ...
        for (int i = 0; i < numClouds; i++)
        {
            ...
            //Добавлення хмарки в масив cloudInstances
